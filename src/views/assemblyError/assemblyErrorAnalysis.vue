<template>
    <div>
        <el-row>
            <el-col :span="18" style="border:2px solid #909399;">
                <div class="grid-content bg-purple">
                    <div id="graph-chart" style="height:850px;padding:10px">
            ...
            <el-col :span="6" style="padding-left:10px">
                <el-row>
                    <el-col :span="24" style="border:2px solid #909399;height: 300px;">
                        <el-container>
                            <el-header style="text-align:center;height: 24px;margin-top: 2px;">误差源节点强度分析
                            </el-header>
                            <el-main>
                                <div id="bar" style="width:300px;height: 190px;"></div>
                            </el-main>
                            <el-footer style="text-align:center">
                                <el-row>
                                    <el-col :span="12" style="padding-left:50px">
                                        <el-tag>当前装配误差源</el-tag>
                                    </el-col>
                                    <el-col :span="12" style="height:30px;padding-right: 80px;">
                                        <span style="line-height:30px">柔性接头</span>
                                    </el-col>
                                </el-row>
                            </el-footer>
                        </el-container>
                ...
                <el-row style="margin-top: 10px;">
                    <el-col :span="24" style="border:2px solid #909399;height: 300px;">
                        <el-container>
                            <el-header style="text-align:center;height: 24px;margin-top: 2px;">关键装配节点
                            </el-header>
                            <el-main>
                                <div id="bar-2" style="width:300px;height: 190px;"></div>
                            </el-main>
                            <el-footer style="text-align:center">
                                <el-row>
                                    <el-col :span="12" style="padding-left:40px">
                                        <el-tag>当前关键装配节点</el-tag>
                                    </el-col>
                                    <el-col :span="12" style="height:30px;padding-right: 80px;">
                                        <span style="line-height:30px">柔性接头</span>
                                    </el-col>
                ...
                <el-row style="margin-top: 10px;">
                    <el-col :span="24" style="border:2px solid #909399;height: 254px;">
                        <el-container>
                            <el-header style="text-align:center;height: 15px;margin-top: 2px;">误差传递路径
                            </el-header>
                            <el-main>
                                <img src="../../../static/1.png" style="width: 300px;height: 200px;"/>
                            </el-main>
                        </el-container>
                    </el-col>
                </el-row>
